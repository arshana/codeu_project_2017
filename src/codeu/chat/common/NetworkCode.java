...
public final class NetworkCode {
  ...
  public static final int
      ...
      NEW_INTEREST_REQUEST = 33,
      NEW_INTEREST_RESPONSE = 34,
      GET_INTEREST_REQUEST = 35,
      GET_INTEREST_RESPONSE = 36,
      REMOVE_INTEREST_REQUEST = 37,
      ADD_MEMBER_REQUEST = 38,
      ADD_MEMBER_RESPONSE = 39,
      ADD_OWNER_REQUEST = 40,
      ADD_OWNER_RESPOND = 41;
}
